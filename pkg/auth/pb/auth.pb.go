...
func (x *CheckUserBlockedResponse) GetStatus() int64 {
	if x != nil {
		return x.Status
	}
	return 0
...
var file_pkg_auth_pb_auth_proto_rawDesc = []byte{
	...
	0x06, 0x75, 0x73, 0x65, 0x72, 0x69, 0x64, 0x32, 0xa7, 0x05, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68,
...
var file_pkg_auth_pb_auth_proto_depIdxs = []int32{
	...
	1,  // 8: api.pb.auth.AuthService.Register:output_type -> api.pb.auth.RegisterResponse
	3,  // 9: api.pb.auth.AuthService.Login:output_type -> api.pb.auth.LoginResponse
	5,  // 10: api.pb.auth.AuthService.ResetPassword:output_type -> api.pb.auth.ResetPasswordResponse
	7,  // 11: api.pb.auth.AuthService.AdminLogin:output_type -> api.pb.auth.AdminLoginResponse
	9,  // 12: api.pb.auth.AuthService.AdminSignup:output_type -> api.pb.auth.AdminSignupResponse
	11, // 13: api.pb.auth.AuthService.ForgotPassWord:output_type -> api.pb.auth.ForgotPasswordResponse
	13, // 14: api.pb.auth.AuthService.CheckUserBlocked:output_type -> api.pb.auth.CheckUserBlockedResponse
	15, // 15: api.pb.auth.AuthService.BlockUser:output_type -> api.pb.auth.BlockUserResponse
